...
namespace websockets
{
  ...
  typedef std::function< void( WebsocketsClient &, WebsocketsMessage, uint32_t ) > MessageCallback;
  typedef std::function< void( WebsocketsMessage, uint32_t ) > PartialMessageCallback;

  typedef std::function< void( WebsocketsClient &, WebsocketsEvent, WSInterfaceString, uint32_t ) > EventCallback;
  typedef std::function< void( WebsocketsEvent, WSInterfaceString, uint32_t ) > PartialEventCallback;
  ...
  class WebsocketsClient
  {
    ...
    void onMessage( const MessageCallback callback, uint32_t );
    void onMessage( const PartialMessageCallback callback, uint32_t );

    void onEvent( const EventCallback callback, uint32_t );
    void onEvent( const PartialEventCallback callback, uint32_t );
