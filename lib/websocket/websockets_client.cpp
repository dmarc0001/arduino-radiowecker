...
namespace websockets
{
  ...
  WebsocketsClient::WebsocketsClient( std::shared_ptr< network::TcpClient > client )
      ...
      , _messagesCallback( []( WebsocketsClient &, WebsocketsMessage, uint32_t ) {} )
      , _eventsCallback( []( WebsocketsClient &, WebsocketsEvent, WSInterfaceString, uint32_t ) {} )
      , _instance( 0 )
  ...
  HandshakeRequestResult generateHandshake( const WSString &host,
                                            const WSString &uri,
...
#ifdef ESP8266
    if ( this->_optional_ssl_fingerprint || ( this->_optional_ssl_rsa_cert && this->_optional_ssl_rsa_private_key ) ||
         ( this->_optional_ssl_ec_cert && this->_optional_ssl_ec_private_key ) || this->_optional_ssl_trust_anchors ||
  ...
  bool WebsocketsClient::connect( WSInterfaceString _url )
  {
    ...
    return this->connect( internals::fromInternalString( host ), port, internals::fromInternalString( uri ) );
  }
  ...
  bool WebsocketsClient::connect( WSInterfaceString host, int port, WSInterfaceString path )
  {
    ...
    auto handshake =
        generateHandshake( internals::fromInterfaceString( host ), internals::fromInterfaceString( path ), _customHeaders );
    ...
    this->_eventsCallback( *this, WebsocketsEvent::ConnectionOpened, {}, this->_instance );
    return true;
  }
  ...
  void WebsocketsClient::onMessage( MessageCallback callback, uint32_t instance )
  {
    this->_messagesCallback = callback;
    this->_instance = instance;
  }

  void WebsocketsClient::onMessage( PartialMessageCallback callback, uint32_t instance )
  {
    this->_instance = instance;
    this->_messagesCallback = [ callback ]( WebsocketsClient &, WebsocketsMessage msg, uint32_t instance )
    { callback( msg, instance ); };
  }

  void WebsocketsClient::onEvent( EventCallback callback, uint32_t instance )
  {
    this->_eventsCallback = callback;
    this->_instance = instance;
  }

  void WebsocketsClient::onEvent( PartialEventCallback callback, uint32_t instance )
  {
    this->_instance = instance;
    this->_eventsCallback = [ callback ]( WebsocketsClient &, WebsocketsEvent event, WSInterfaceString data, uint32_t instance )
  ...
  bool WebsocketsClient::poll()
  {
    ...
    while ( available() && _endpoint.poll() )
    {
      ...
      {
        this->_messagesCallback( *this, std::move( msg ), this->_instance );
      }
  ...
  bool WebsocketsClient::available( const bool activeTest )
  {
    ...
    if ( updatedConnectionOpen != this->_connectionOpen )
    {
      ...
      this->_eventsCallback( *this, WebsocketsEvent::ConnectionClosed, "", this->_instance );
    }
  ...
  {
    this->_eventsCallback( *this, WebsocketsEvent::GotPing, message.data(), this->_instance );
  }

  void WebsocketsClient::_handlePong( const WebsocketsMessage message )
  {
    this->_eventsCallback( *this, WebsocketsEvent::GotPong, message.data(), this->_instance );
  }

  void WebsocketsClient::_handleClose( const WebsocketsMessage message )
  {
    this->_eventsCallback( *this, WebsocketsEvent::ConnectionClosed, message.data(), this->_instance );
  }
